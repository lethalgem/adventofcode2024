...
file = open(
    "/Users/iancash/Documents/Code/adventofcode2024/day-8/challenge-1/input.txt"
)
...
for freq in unique_frequencies:
    ...
    for i in range(row_count):
        ...
        for j in range(i + 1, row_count):
            ...
            antinode_1 = pd.DataFrame({'freq': first_freq['freq'], 'row': [second_freq['row'] + row_distance], 'col': [second_freq['col'] + col_distance]})
            antinode_2 = pd.DataFrame({'freq': first_freq['freq'], 'row': [first_freq['row'] - row_distance], 'col': [first_freq['col'] - col_distance]})
